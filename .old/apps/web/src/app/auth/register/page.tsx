  ...
  return (
    <div className="animate-in fade-in zoom-in-95 duration-500">
      <div className="mb-10 text-center lg:text-left">
        ...
        <p className="text-gray-400">Automatize seu suporte e reduza a fila de chamados hoje mesmo.</p>
      </div>
      ...
      <div className="flex items-center my-6">
         ...
         <span className="px-4 text-xs font-semibold text-gray-500 uppercase tracking-wide">Ou use seu e-mail</span>
         <div className="flex-grow border-t border-gray-800"></div>
      </div>
      ...
      <p className="mt-8 text-center text-sm text-gray-500 font-medium">
        Já possui uma conta? <Link href="/auth/login" className="text-blue-500 hover:text-blue-400 font-bold transition-colors">Faça login</Link>
      </p>
    </div>
  );
}
